...
static volatile int32_t g_17 = 0x434392F2L;
static volatile int32_t *volatile g_16[4] = {&g_17, &g_17, &g_17, &g_17};
static struct S0 g_20 = {0x03L, 0xD3L};
static int32_t g_25 = 0x16C28CBDL;
static uint32_t g_46 = 0UL;
static int64_t g_49[3] = {0x20EB8FC401265A1BLL, 0x20EB8FC401265A1BLL, 0x20EB8FC401265A1BLL};
static struct S0 *g_65 = &g_20;
static int32_t g_74 = 0x6DCF8E45L;

static uint16_t func_1(void);
static uint8_t func_2(uint32_t p_3, uint32_t p_4);
...
static uint16_t func_1(void) {
  ...
  struct S0 **l_95 = &g_65;
  struct S0 *l_96 = &g_20;
  int32_t l_97[1][5][4] = {{{0x48233F39L, (-5L), (-5L), 0x48233F39L}, {0xA6B6A2D8L, (-5L), 1L, (-5L)}, {(-5L), (-3L), 1L, 1L}, {0xA6B6A2D8L, 0xA6B6A2D8L, (-5L), 1L}, {0x48233F39L, (-3L), 0x48233F39L, (-5L)}}};
  int i, j, k;
  l_97[0][3][0] = (func_2(g_5, l_6), (+((safe_rshift_func_uint64_t_u_s((l_6 != (safe_rshift_func_uint8_t_u_s((((l_6 == (safe_unary_minus_func_int32_t_s((g_20.f1 && ((l_6, (safe_lshift_func_uint8_t_u_s(((safe_rshift_func_int64_t_s_s((((l_96 = (((((safe_div_func_int16_t_s_s(((safe_div_func_uint8_t_u_u(((g_20.f1 | (l_6 | g_49[0])) >= g_46), g_74)) < l_6), 1L)) | g_20.f1) > g_46) & 0x388EEC896690B97FLL), &g_20)) == &g_20) | g_49[1]), l_6)) < 0xD233DB8BL), 0))), g_49[2]))))) & l_6) ^ 5UL), g_74))), g_20.f1)), 1L)));
  return g_25;
}

static uint8_t func_2(uint32_t p_3, uint32_t p_4) {
  int32_t *l_13[5];
  struct S0 l_18 = {1L, 0x54L};
  struct S0 *l_19 = (void *)0;
  int32_t **l_21 = &l_13[1];
  int i;
  for (i = 0; i < 5; i++)
    l_13[i] = (void *)0;
  (*l_21) = ((g_20 = ((((safe_lshift_func_int32_t_s_s((safe_lshift_func_int8_t_s_s(((g_5 ^ (((safe_lshift_func_uint16_t_u_s(((void *)0 != l_13[2]), 4)), g_5) && (((0x479BL ^ ((safe_div_func_uint64_t_u_u((0x3CC47D1AFD061A65LL <= (p_4 && (l_13[0] != g_16[0]))), 4UL)) <= 0xD635L)), g_5), 65527UL))) >= g_5), 5)), p_4)) != 0x0CAAD901516EA3DELL) <= g_5), l_18)), (void *)0);
  if (p_3) {
    int32_t *l_24 = &g_25;
    for (l_18.f0 = 0; (l_18.f0 > 2); l_18.f0++) {
      return g_20.f1;
    }
    l_24 = l_24;
  } else {
    ...
    struct S0 **l_64 = &l_19;
    int64_t *l_75[3];
    int32_t l_76 = 0x292F9027L;
    int64_t l_77 = 3L;
    int32_t l_78 = 0x2BDABF61L;
    int i;
    for (i = 0; i < 5; i++)
      l_50[i] = 0x9535F447L;
    for (i = 0; i < 3; i++)
